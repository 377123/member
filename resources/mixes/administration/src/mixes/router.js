...
import UserRecycling from '../pages/UserRecycling.vue';
import UserMessageManager from '../pages/UserMessageManager.vue';
import UserMessageCreate from '../pages/UserMessageCreate.vue';
import UserMessageGroup from '../pages/UserMessageGroup.vue';
import UserGroupCreate from '../pages/UserGroupCreate.vue';
    ...
    injection.routers = [
        ...injection.routers,
        {
            children: [
                ...
                {
                    beforeEnter: injection.middleware.requireAuth,
                    component: UserMessageCreate,
                    path: 'user/message/create',
                },
                {
                    beforeEnter: injection.middleware.requireAuth,
                    component: UserMessageGroup,
                    path: 'user/message/groups',
                },
                {
                    beforeEnter: injection.middleware.requireAuth,
                    component: UserGroupCreate,
                    path: 'user/message/groups/create',
                },
                {
                    beforeEnter: injection.middleware.requireAuth,
